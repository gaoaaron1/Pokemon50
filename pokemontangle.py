...
snorlaxClick = pygame.mixer.Sound("Snorlax_Sound2.wav")
			...
			for j in range(0,y):
				...
				# 	turn = 0
					...
					if (turn == 0):
						...
						elif arrayNew[arraySwap0[1]][arraySwap0[0]] == 4:
							pygame.mixer.Sound.play(snorlaxClick)
						...
						if arrayNew[arraySwap1[1]][arraySwap1[0]] == 3:
							...
							pygame.mixer.Sound.play(magikarpClick)
						elif arrayNew[arraySwap1[1]][arraySwap1[0]] == 4:
							pygame.mixer.Sound.play(snorlaxClick)
						'''
